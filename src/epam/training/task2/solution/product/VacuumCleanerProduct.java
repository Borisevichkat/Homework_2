...
public class VacuumCleanerProduct  extends Product{
    ...
    public String toString() {
        return String.format("Power Consunption=%f, Filter Type=%f, Bag Type=%f, Wand Type=%f, Motor Speed Regulation=%f, Cleaning Width=%f, Price=%f",
    ...
    public static RefrigeratorProduct.Builder parseString(String[] params) {
