...
public class ShowCheapestProductImpl implements Command {
    @Override
    public String execute(String request) {
        try {
            ServiceProvider serviceProvider = ServiceProvider.getInstance();
            CheapestProductService cheapestProductService = serviceProvider.getCheapestProductService();
            ArrayList<Product> products = cheapestProductService.getCheapestProducts();

            String outputLine = "The cheapest product(s):\n";
